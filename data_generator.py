...
class DataGenerator(object):
    ...
    def make_data_tensor(self, train=True, shuffle = True, analysis=False, points_to_analyze = 1):
        if train:
        ...
        if analysis:
            folders = self.metaval_character_folders
            num_total_batches = points_to_analyze
        ...
        for i in range(num_total_batches):
            ...
            if analysis:
                odds = slice(1, self.num_classes * self.num_samples_per_class, 2)
                if i == 0:
                    constant_filenames = filenames[odds]
                    filenames[odds] = constant_filenames
                else:
                    filenames[odds] = constant_filenames
                print("Changed")
        ...
        for i in range(self.batch_size):
            ...
            if FLAGS.datasource == 'omniglot' and shuffle:
            ...
            for k in range(self.num_samples_per_class):
                ...
                if FLAGS.datasource == 'omniglot' and shuffle: # and FLAGS.train:
